...
export const ICONS: Record<string, IconDef> = {
  ...
  'eye-off': {
    paths: [
      'M4 4l16 16',
      'M9.9 5.2A10.5 10.5 0 0 1 12 5c6.5 0 10 6.5 10 6.5a17 17 0 0 1-3.2 4.2',
      'M6.3 7.4A16.6 16.6 0 0 0 2 11.5S5.5 18 12 18a10.4 10.4 0 0 0 4-.8',
      'M10 10.2a2.7 2.7 0 0 0 3.8 3.8'
    ],
    fallback: '🙈'
  },
